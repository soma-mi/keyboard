...
enum layers { MAC, WIN, NUM, DEV };

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC] = LAYOUT_numpad_6x4(
        TO(MAC),      TO(WIN),       TO(NUM),         MO(DEV),
    ...
    [WIN] = LAYOUT_numpad_6x4(
        TO(MAC),       TO(WIN),       TO(NUM),        MO(DEV),
        KC_NO,         KC_NO,         KC_NO,          LCTL(KC_MINS),
        KC_NO,         KC_NO,         KC_NO,
        LGUI(KC_LEFT), KC_NO,         LGUI(KC_RGHT),  RCS(KC_SCLN),
        KC_NO,         KC_NO,         KC_NO,
        LSG(KC_LEFT),                 LSG(KC_RGHT),   LGUI(KC_UP)),
